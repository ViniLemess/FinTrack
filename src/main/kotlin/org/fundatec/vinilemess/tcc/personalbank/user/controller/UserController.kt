package org.fundatec.vinilemess.tcc.personalbank.user.controller
...
import org.fundatec.vinilemess.tcc.personalbank.user.domain.response.UserResponse
import org.fundatec.vinilemess.tcc.personalbank.user.service.UserService
...
class UserController(private val userService: UserService) {
    ...
    private fun User.buildResponse() = UserResponse(this.name, this.email, this.userIdentifier)
}